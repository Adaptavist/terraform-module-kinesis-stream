...
variable "max_shard_scaling_factor" {
  type        = number
  default     = 5
  description = "Maximum factor by which min_shard_count can scale. For example, given min_shard_count=2 and max_shard_scaling_factor=5, the max shard count will be 10"
}
